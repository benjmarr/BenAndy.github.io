...
document.getElementById("press").addEventListener("click", function() {
  ...
  document.getElementById("userPass").innerHTML = "You were just about to give your Snapchat login details to a random website? You don't know what will happen! Giving your usernames and passwords to random unofficial websites is one of the worst things you can do these days! If you've given out your log in details for accounts to random websites, you should change your passwords right away - you don't know who could have access to your accounts now. The only official Snapchat platforms are applications and websites made by Snap, Inc.. Oh, and don't worry - if you were stupid enough to type your username and password in above, it wasn't logged to any database. If you don't believe me, check the code by pressing the GitHub icon below.<br /><br />Change your Snapchat password <a href='https://accounts.snapchat.com/accounts/change_password' target='_blank'>HERE</a>.";
  opacity("img1", "1", 1000);
