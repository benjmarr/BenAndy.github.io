  	...
  	var commandfunction = "";
		...
		switch(commandfunction)
		{
			case "commands":
				...
				API.on(API.chatLog("/score"));
				API.on(API.chatLog("- Shows the current score of the current Dj."));
			...
			break;
			case "score":
				API.on(API.chatLog("Score of the current Dj is" + API.getScore()));
			break;
		}
	}
